...
const ShortlyInput = () => {
  console.log('object');
  return (
    <div className="bg-sDarkViolet inputBg p-4 sm:p-10 flex flex-col sm:flex-row w-full sm:w-4/5 self-center font-poppins rounded-md relative -mt-16 sm:-mt-12 mb-20 sm:mb-24 shadow-md">
